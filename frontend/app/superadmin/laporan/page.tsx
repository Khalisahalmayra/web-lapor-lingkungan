          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            <div>
              ...
              <p className="text-gray-500 mt-3 text-base lg:text-lg">
                Super admin hanya dapat memantau aktivitas
                laporan lingkungan.
              </p>
            </div>
              ...
              <table className="w-full min-w-[900px]">
                ...
                <tbody>
                  {laporan.map((item, index) => (
                    ...
                    >
                      <td className="px-6 py-5 font-bold text-[#052e24] whitespace-nowrap">
                        {item.id}
                      </td>

                      <td className="px-6 py-5 text-black whitespace-nowrap">
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-red-500 mt-2 leading-relaxed">
                  Super admin hanya memiliki akses untuk
                  memantau laporan dan aktivitas sistem tanpa
                  melakukan perubahan data laporan.
                </p>
              </div>
            </div>
          </div>
